    ...
    <>
      ...
      <Routes>
        ...
        <Route
          path="/admin"
          element={
            (token && (role == "ADMIN,USER" || role == "SELLER,USER")) ? <AdminLayout /> : <AdminLogin />
          }
        >
          {(token && (role == "ADMIN,USER" || role == "SELLER,USER")) ? (
            <>
              <Route index element={<Dashboard />} />
              <Route path="/admin/profile" element={<Profile />} />
              <Route path="/admin/products" element={<Products />} />
              {role == "SELLER,USER" ?
                <Route path="/admin/products/add" element={<AddProduct />} /> : null
              }
              <Route
              ...
              {role != "SELLER,USER" ?
                <Route path="/admin/customers" element={<Customers />} /> : null
              }
