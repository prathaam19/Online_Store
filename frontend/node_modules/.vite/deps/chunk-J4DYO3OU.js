...
function deepClone2(source) {
  if (React8.isValidElement(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
...
function mergeBreakpointsInOrder(breakpointsInput, ...styles) {
  ...
  const mergedOutput = [emptyBreakpoints, ...styles].reduce((prev2, next2) => deepmerge2(prev2, next2), {});
...
var PropsContext = React9.createContext(void 0);
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-J4DYO3OU.js.map
