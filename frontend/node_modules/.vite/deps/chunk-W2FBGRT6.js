...
var ClassNameGenerator_default2 = ClassNameGenerator;
...
var elementAcceptingRef2 = chainPropTypes2(import_prop_types16.default.element, acceptingRef2);
elementAcceptingRef2.isRequired = chainPropTypes2(import_prop_types16.default.element.isRequired, acceptingRef2);
...
var elementTypeAcceptingRef_default2 = chainPropTypes2(import_prop_types17.default.elementType, elementTypeAcceptingRef2);

// node_modules/@mui/material/node_modules/@mui/utils/esm/exactProp/exactProp.js
init_extends();
var specialProperty3 = "exact-prop: ​";
function exactProp3(propTypes) {
  if (false) {
    return propTypes;
  }
  return _extends({}, propTypes, {
    [specialProperty3]: (props) => {
      const unsupportedProps = Object.keys(props).filter((prop) => !propTypes.hasOwnProperty(prop));
      if (unsupportedProps.length > 0) {
        return new Error(`The following props are not supported: ${unsupportedProps.map((prop) => `\`${prop}\``).join(", ")}. Please remove them.`);
      }
...
var refType2 = import_prop_types18.default.oneOfType([import_prop_types18.default.func, import_prop_types18.default.object]);
...
function deprecatedPropType2(validator2, reason) {
  if (false) {
    return () => null;
  }
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React34.useLayoutEffect : React34.useEffect;
...
var maybeReactUseId3 = React35["useId".toString()];
function useId3(idOverride) {
  if (maybeReactUseId3 !== void 0) {
    const reactId = maybeReactUseId3();
    return idOverride != null ? idOverride : reactId;
  }
...
function useIsFocusVisible2() {
  const ref = React41.useCallback((node) => {
    if (node != null) {
      prepare(node.ownerDocument);
    }
  }, []);
  const isFocusVisibleRef = React41.useRef(false);
...
function getNormalizedScrollLeft2(element, direction) {
  const scrollLeft = element.scrollLeft;
  if (direction !== "rtl") {
    return scrollLeft;
  }
  const type = detectScrollType2();
  switch (type) {
    case "negative":
...
function getValidReactChildren2(children) {
  return React43.Children.toArray(children).filter((child) => React43.isValidElement(child));
}
...
init_extends();
function resolveProps3(defaultProps, props) {
...
function getReactElementRef2(element) {
  if (parseInt(React44.version, 10) >= 19) {
    var _element$props;
...
function createMuiStrictModeTheme(options, ...args) {
  return createTheme_default2(deepmerge2({
...
Use unitless line heights instead.` : formatMuiErrorMessage3(6));
    }
...
See https://mui.com/r/migration-v4/#mui-material-styles for more details.` : formatMuiErrorMessage3(14));
}
...
You have to import it from @mui/styles.
See https://mui.com/r/migration-v4/#mui-material-styles for more details.` : formatMuiErrorMessage3(15));
}
...
You have to import it from @mui/styles.
See https://mui.com/r/migration-v4/#mui-material-styles for more details.` : formatMuiErrorMessage3(16));
}
...
// node_modules/@mui/material/styles/experimental_extendTheme.js
var _excluded13 = ["colorSchemes", "cssVarPrefix", "shouldSkipGeneratingVar"];
...
function experimental_sx() {
  throw new Error(true ? `MUI: The \`experimental_sx\` has been moved to \`theme.unstable_sx\`.For more details, see https://github.com/mui/material-ui/pull/35150.` : formatMuiErrorMessage3(20));
}
...
export {
  ...
  createGrid,
  createStack,
  chainPropTypes2 as chainPropTypes,
  elementAcceptingRef_default2 as elementAcceptingRef_default,
  elementTypeAcceptingRef_default2 as elementTypeAcceptingRef_default,
  exactProp3 as exactProp,
  getDisplayName3 as getDisplayName,
  HTMLElementType2 as HTMLElementType,
  refType_default2 as refType_default,
  createChainedFunction2 as createChainedFunction,
  debounce2 as debounce,
  deprecatedPropType2 as deprecatedPropType,
  isMuiElement3 as isMuiElement,
  ownerDocument2 as ownerDocument,
  ownerWindow2 as ownerWindow,
  requirePropFactory2 as requirePropFactory,
  setRef2 as setRef,
  useEnhancedEffect_default3 as useEnhancedEffect_default,
  useId3 as useId,
  unsupportedProp2 as unsupportedProp,
  ...
  useIsFocusVisible2 as useIsFocusVisible,
  getScrollbarSize2 as getScrollbarSize,
  detectScrollType2 as detectScrollType,
  getNormalizedScrollLeft2 as getNormalizedScrollLeft,
  usePreviousProps_default2 as usePreviousProps_default,
  getValidReactChildren2 as getValidReactChildren,
  visuallyHidden_default2 as visuallyHidden_default,
  resolveProps3 as resolveProps,
  clamp_default3 as clamp_default,
  isHostComponent_default2 as isHostComponent_default,
  appendOwnerState_default2 as appendOwnerState_default,
  extractEventHandlers_default2 as extractEventHandlers_default,
  mergeSlotProps_default2 as mergeSlotProps_default,
  resolveComponentProps_default2 as resolveComponentProps_default,
  useSlotProps_default2 as useSlotProps_default,
  getReactElementRef2 as getReactElementRef,
  adaptV4Theme,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-W2FBGRT6.js.map
